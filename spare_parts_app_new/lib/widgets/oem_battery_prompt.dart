  ...
  await showDialog(
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: const Text(
        ...
        'block notifications when the app is closed. To ensure you always receive alerts, please disable battery optimization for Parts Mitra in your device settings.',
      ),
      actions: [
        TextButton(
